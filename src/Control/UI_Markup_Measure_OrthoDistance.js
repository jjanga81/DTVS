...
let UIMarkup_Measure_OrthoDistance = function (uiBase, view, VIZCore) {
    let scope = this;
            ...
            case 1:
                {
                    ...
                    let targetPos = currentPlane.projectPoint(pickData.position);
                    //let targetLength = currentPlane.distanceToPoint(pick);

                    uiBase.currentReviewItem.drawitem.position[3] = targetPos; // 직교 위치
                    uiBase.currentReviewItem.itemType = VIZCore.Enum.REVIEW_TYPES.RK_MEASURE_ORTHODISTANCE;
...
export default UIMarkup_Measure_OrthoDistance;