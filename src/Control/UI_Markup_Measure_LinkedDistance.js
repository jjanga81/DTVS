 ...
 */
 ...
 let UIMarkup_Measure_LinkedDistance = function (uiBase, view, VIZCore) {
    let scope = this;
    ...
    this.Start = function () {
        ...
        uiBase.currentReviewItem.itemType = VIZCore.Enum.REVIEW_TYPES.RK_MEASURE_LINKED_DISTANCE;
...
export default UIMarkup_Measure_LinkedDistance;