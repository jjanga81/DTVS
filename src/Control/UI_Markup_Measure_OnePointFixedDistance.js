 ...
 */
 ...
 let UIMarkup_Measure_OnePointFixedDistance = function (uiBase, view, VIZCore) {
    let scope = this;
            ...
            case 0:
                {
                    ...
                    if(pickData.preselectKind === VIZCore.Enum.PRESELECT_PICK_KIND.EDGE) {
                        ...
                        // 점대 여러점은 축거리 표시를 하지 않음.
                        uiBase.currentReviewItem.drawitem.axis = false;
            ...
            case 2:
                {
                    ...
                    let oldReviewItem = uiBase.currentReviewItem;
                    ...
                    //반복
                    view.Control.SetMode(VIZCore.Enum.CONTROL_STATE.MARKUP, VIZCore.Enum.REVIEW_TYPES.RK_MEASURE_ONE_POINT_FIXED_DISTANCE); //다시 시작
                    //view.Control.SetStep
                    let markup = view.Control.GetUIMode();
                    markup.SetStep(1);  //측정 진행
                    uiBase.currentReviewItem.drawitem.position[0] = new VIZCore.Vector3().copy(oldReviewItem.drawitem.position[0]);
...
export default UIMarkup_Measure_OnePointFixedDistance;