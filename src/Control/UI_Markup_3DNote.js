...
let UIMarkup_3DNote = function (uiBase, view, VIZCore) {
    let scope = this;
    ...
    this.Start = function () {
        ...
        {
            uiBase.currentReviewItem.itemType = VIZCore.Enum.REVIEW_TYPES.RK_3D_NOTE;
            ...
            case 0:
                {
                    ...
                    if (uiBase.currentReviewItem.text.position === undefined) {
                        //최초 위치 설정
                        let world = view.Camera.screen2WorldWithMatrix(mvpMatrix, new VIZCore.Vector3(x, y, 0));
                        uiBase.currentReviewItem.text.position = world;
                    }
                    else {
...
export default UIMarkup_3DNote;