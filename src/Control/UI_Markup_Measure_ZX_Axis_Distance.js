...
let UIMarkup_Measure_ZX_Axis_Distance = function (uiBase, view, VIZCore) {
    let scope = this;
            ...
            case 0:
                {
                    ...
                    if(pickData.preselectKind === VIZCore.Enum.PRESELECT_PICK_KIND.EDGE) {
                        ...
                        uiBase.currentReviewItem.itemType = VIZCore.Enum.REVIEW_TYPES.RK_MEASURE_ZX_AXIS_DISTANCE;
...
export default UIMarkup_Measure_ZX_Axis_Distance;